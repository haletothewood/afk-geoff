...
| `afk init --with-github-actions` | installs the remote execution harness | `.github/workflows/afk-run.yml` exists without overwriting existing workflows by default |
