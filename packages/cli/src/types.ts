import type { AgentRunner, ExecutionBackend, IssueMirror, PullRequestReviewSource, ResultPublisher, SourceUpdater, WorkflowDispatcher, WorkflowRunSource } from "@afk-geoff/core";
...
export interface CliContext {
  ...
  github: (IssueMirror & ChangeRequestPublisher & Partial<PullRequestReviewSource> & Partial<WorkflowDispatcher> & Partial<WorkflowRunSource>) | undefined;
...
export interface CliDependencies {
  githubFactory?: (token: string) => IssueMirror & ChangeRequestPublisher & Partial<PullRequestReviewSource> & Partial<WorkflowDispatcher> & Partial<WorkflowRunSource>;
